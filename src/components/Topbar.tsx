...
export default function Topbar() {
    ...
    return (
        <header className="fixed top-0 right-0 h-20 bg-transparent z-40 flex items-center justify-between px-8 pointer-events-none transition-all duration-300" 
            ...
            <div className="flex items-center gap-6 pointer-events-auto">
                <button className="p-2.5 text-app-text-muted hover:text-app-text hover:bg-white/10 rounded-xl bg-app-card border border-app-border transition-all relative group">
                ...
                <div className="flex items-center gap-4 bg-app-card backdrop-blur-md border border-app-border p-1.5 pr-4 rounded-2xl shadow-xl">
                    <div className="w-10 h-10 rounded-xl bg-app-accent flex items-center justify-center text-sm font-bold text-white shadow-lg overflow-hidden border border-white/20">
                ...
                <button 
                    onClick={logout}
                    className="p-2.5 text-rose-400 hover:text-rose-100 hover:bg-rose-500/20 rounded-xl bg-app-card border border-app-border transition-all shadow-lg group"
                    title="Cerrar sesión"
                >
